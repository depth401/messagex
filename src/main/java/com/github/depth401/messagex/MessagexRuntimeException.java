...
public final class MessagexRuntimeException extends RuntimeException {
  ...
  public MessagexRuntimeException(String message) {
    this(message, DEFAULT_MASKERS);
  }

  public MessagexRuntimeException(String message, List<Masker> maskers) {
    this(message, null, DEFAULT_EXCEPTION_FILTERS, DEFAULT_MESSAGE_FILTERS, maskers);
  }

  public MessagexRuntimeException(String message, Throwable cause) {
  ...
  public MessagexRuntimeException(Throwable cause) {
  ...
  public static class Builder {
    ...
    public MessagexRuntimeException build() {
      return new MessagexRuntimeException(
          this.message,
          this.cause,
